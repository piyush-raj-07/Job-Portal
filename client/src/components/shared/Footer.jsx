        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h2 className="text-2xl font-bold mb-4">
              <span className="text-blue-500">Job</span>Portal
            </h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/jobs" className="text-gray-400 hover:text-blue-500 transition-colors">
                  Browse Jobs
                </a>
              </li>
              <li>
                <a href="/companies" className="text-gray-400 hover:text-blue-500 transition-colors">
                  Companies
                </a>
              </li>
              <li>
